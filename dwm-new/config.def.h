...
static const char *fonts[]          = { "mplus Nerd Font:size=16" };
static const char dmenufont[]       = "Comfortaa:size=16";
static const char darkgray[]        = "#1b1e2b";
static const char white[]           = "#f8f8f2";
static const char green[]           = "#39ff14";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { white,     darkgray,  white     },
	[SchemeSel]  = { green,     darkgray,  green     },
};
