...
static const char col_gray1[]       = "#373e4d";
static const char col_gray2[]       = "#aaaaaa";
static const char col_gray3[]       = "#eeeeef";
static const char col_gray4[]       = "#fa5aa4";
...
static const char *dmenucmd[] = { "./scripts/dmenu_recent_aliases.sh", "-m", dmenumon, "-c", "-l", "10", "-fn", dmenufont, NULL };
