...
local sl_hl_sep = vim.api.nvim_get_hl_by_name("StatusLineNC", true)
...
vim.api.nvim_set_hl(0, "SLTermIcon", { fg = "#b668cd", bg = "#16161e" })
...
vim.api.nvim_set_hl(0, "SLSep", { fg = "#16161e", bg = "NONE" })
...
local mode = {
    ...
    color = function()
        ...
        return { fg = mode_color[vim.fn.mode()], bg = "#16161e" }
    end,
    padding = 0,
}
